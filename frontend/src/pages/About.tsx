...
const About: React.FC = () => {
  ...
  const teamMembers = [
    {
      name: isRTL ? 'عضو تیم ۱' : 'Team Member 1',
    ...
    {
      name: isRTL ? 'عضو تیم ۲' : 'Team Member 2',
      role: t('about.role.fullstack'),
      bio: isRTL
        ? 'توسعه‌دهنده با تجربه در ساخت برنامه‌های وب مقیاس‌پذیر و رابط‌های کاربری تعاملی.'
        : 'Experienced developer building scalable web applications and interactive user interfaces.',
    },
    {
      name: isRTL ? 'عضو تیم ۳' : 'Team Member 3',
    ...
    {
      name: isRTL ? 'عضو تیم ۴' : 'Team Member 4',
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] p-4 md:p-6 lg:p-8">
      <div className="max-w-6xl mx-auto space-y-12">
        {/* Hero Section */}
        <section className={cn("text-center space-y-6", isRTL && "text-content")}>
        ...
        <Card className="bg-gradient-to-r from-primary/5 to-accent/10 border-none shadow-soft">
          <CardContent className={cn("py-8 text-center", isRTL && "text-content")}>
